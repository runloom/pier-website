...
export const zh = {
  ...
  mock: {
    ...
    sidebarTitle: "会话",
    sessions: [
      { agent: "claude", branch: "feat/checkout", status: "运行中", kind: "run" },
      { agent: "codex", branch: "fix/flaky-test", status: "需要你处理", kind: "needs" },
      { agent: "opencode", branch: "docs/site", status: "出错", kind: "error" },
      { agent: "grok", branch: "refactor/api", status: "完成", kind: "done" },
    ],
    terminalTab: "claude · feat/checkout",
    termLines: [
      { kind: "cmd", text: "claude" },
      { kind: "out", text: "正在读取 src/checkout/cart.ts …" },
      { kind: "out", text: "已更新 3 个文件，运行测试中" },
