...
export const en: Dict = {
  ...
  mock: {
    windowTitle: "Pier — acme-app",
    sidebarTitle: "Sessions",
    sessions: [
      { agent: "claude", branch: "feat/checkout", status: "Running", kind: "run" },
      { agent: "codex", branch: "fix/flaky-test", status: "Needs you", kind: "needs" },
      { agent: "opencode", branch: "docs/site", status: "Error", kind: "error" },
      { agent: "grok", branch: "refactor/api", status: "Done", kind: "done" },
    ],
    terminalTab: "claude · feat/checkout",
    termLines: [
      { kind: "cmd", text: "claude" },
      { kind: "out", text: "Reading src/checkout/cart.ts …" },
      { kind: "out", text: "Updated 3 files, running tests" },
      { kind: "ok", text: "✓ 24 tests passed (2.1s)" },
      { kind: "prompt", text: "" },
    ],
    diffTitle: "Changes",
    diffTab: "Working tree · 4 files",
    files: [
      { name: "src/checkout/cart.ts", add: 42, del: 11 },
      { name: "src/checkout/price.ts", add: 18, del: 3 },
      { name: "tests/cart.test.ts", add: 36, del: 0 },
    ],
    stageHunk: "Stage hunk",
    stageFile: "Stage file",
    statusBar: "3 sessions running · 1 needs you",
