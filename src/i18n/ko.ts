...
export const ko: Dict = {
  ...
  mock: {
    ...
    terminalTabs: [
      { title: "checkout", status: "run", kind: "claude" },
      { title: "codex", status: "needs", kind: "codex" },
      { title: "zsh", status: "idle", kind: "shell" },
    ],
    termLines: [
      { kind: "dim", text: "Claude Code · Opus" },
    ...
    composer: "여기에 입력하면 터미널 세션으로 보냅니다",
    agentRunning: "실행 중",
    branch: "feat/checkout",
    changesTab: "변경",
    unstaged: "변경",
    files: [
      { name: "cart.ts", path: "src/checkout", add: 42, del: 11, active: true, letter: "M" },
      { name: "price.ts", path: "src/checkout", add: 18, del: 3, active: false, letter: "M" },
      { name: "cart.test.ts", path: "tests", add: 36, del: 0, active: false, letter: "A" },
    ],
  ...
  features: {
    ...
    items: [
      ...
      {
        title: "파일과 변경",
        body: "프로젝트 파일을 둘러보고, 작업 트리와 스테이징 차이를 검토하며, 파일 또는 덩어리 단위로 스테이지/해제합니다.",
      },
      {
        title: "Canvas",
        body: "방안, 흐름, 도표, 문서, 가벼운 프로토타입을 프로젝트와 함께 저장되는 미리 보기 페이지로 둡니다. 콘텐츠이며 작업 오케스트레이터가 아닙니다.",
      },
      {
        title: "저장되는 레이아웃",
